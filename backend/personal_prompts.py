...
_PERSONAL_RULES_EN = (
    ...
    "3. PROBATION: Use the *value* of the 'Probation status' field as the source of truth for whether "
    "they're in probation. Never infer it from other fields. But always phrase it as a normal sentence — "
    "see rule 10.\n"
    ...
    "probation_status, you are not in probation.\"\n"
    "NEVER DO THIS:\n"
    ...
    "  • Infer probation status from hire_date instead of using the given field's value\n"
    ...
    "  • Print internal field names, labels, or key:value pairs anywhere in your answer\n"
)
...
_PERSONAL_RULES_AR = (
    ...
    "3. التجربة: استخدم قيمة حقل 'Probation status' كمصدر الحقيقة. لا تستنتجه من حقول أخرى، لكن لا تكتب اسم الحقل نفسه — اكتب جملة طبيعية (انظر القاعدة 9).\n"
    ...
    "9. صياغة طبيعية (مهم): لا تكتب أبداً اسم الحقل الداخلي أو تنسيق key:value في إجابتك — مثلاً لا تكتب "
    "\"Probation status: NOT IN PROBATION\" أو \"حالة التجربة: نشطة\". بدلاً من ذلك اكتب جملة طبيعية يقولها إنسان، "
    "مثل: \"أنت غير خاضع لفترة تجربة حالياً.\" أو \"أنت لا تزال في فترة التجربة حتى 1 مارس 2026.\"\n"
)
...
_PERSONAL_RULES_EGY = (
    ...
    "3. التجربة: استخدم قيمة حقل 'Probation status' كمصدر الحقيقة، بس متكتبش اسم الحقل — اكتب جملة طبيعية (شوف رقم 9).\n"
    ...
    "9. صياغة طبيعية (مهم): متكتبش اسم الحقل الداخلي أو key:value في إجابتك أبداً — متقولش \"Probation status: NOT IN PROBATION\". "
    "قول جملة عادية زي: \"إنت مش تحت التجربة دلوقتي.\" أو \"إنت لسه في فترة التجربة لحد 1 مارس.\"\n"
)
...
_PERSONAL_RULES_FRANCO = (
    ...
    "  Q: kam yom aza fedel leya?\n"
    "  A: Fadellak 12 yom agaza sana di.\n"
    "  Q: ana lessa fel probation?\n"
    "  A: La, khalast el probation bta3tak.\n"
    "  Q: hakhod bonus?\n"
    "  A: Aywa, mo2ahhal lel bonus 3ashan 3andak 6 shohoor khidma.\n"
    "BAD (never do this — sounds like a database dump, not a person):\n"
    "  A: Probation status: NOT IN PROBATION.\n"
    "  A: El remaining_days beta3ak howa 12.\n"
    "RULES:\n"
    "1. Use ONLY the employee data block. No guessing.\n"
    "2. Numbers and facts exactly as in the data (days, money, ratings).\n"
    "3. Probation: use the value of 'Probation status' as your source of truth, but say it as a normal "
    "short sentence like the good examples above — never print the field name itself.\n"
    ...
    "8. NATURAL PHRASING (important): Never print raw field names or key:value pairs (see BAD examples "
    "above). Always answer the way a real person texting in Franco would — short, direct, conversational.\n"
)
...
_HYBRID_RULES_FRANCO = (
    ...
    "GOOD EXAMPLE:\n"
    "  Q: law ana G3, hakhod ad eih bonus law rating 5?\n"
    "  A: Enta G3, fa hatakhod le7ad 20% zeyada 3ala el rateb el asasy (36,000 geneih) — ya3ni le7ad "
    "7,200 geneih ziyada [Page 4 | EN].\n"
    "BAD (never do this):\n"
    "  A: Grade: G3. Rating: 5. Bonus_pct: 20%.\n"
    "RULES:\n"
    "1. Egeb 3ala el so2al directly fel gomla el awlany. Mafish intro 3an work model.\n"
    "2. Grade: law fi policy rule 3ala asas el grade, 2ol el grade fi gomla 3adeya (e.g. 'enta G3, fa...').\n"
    ...
    "6. Sayagha tabi3eya: mamnou3 tektib asma2 el fields aw key:value zay el BAD example. Etkallem zay ma "
    "insan 7a2i2i biktib WhatsApp.\n"
)
